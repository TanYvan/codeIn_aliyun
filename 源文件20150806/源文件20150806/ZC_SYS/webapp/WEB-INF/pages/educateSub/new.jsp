...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/educateSub/insertEducateSub.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="educateSub.graduatedate" type="text" class='{required:true} Wdate' onFocus="WdatePicker()" size="30" />
					...
					<tr>
						...
						<td>
							<input name="educateSub.specialty" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="educateSub.school" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="educateSub.degreeletter" type="text" size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
