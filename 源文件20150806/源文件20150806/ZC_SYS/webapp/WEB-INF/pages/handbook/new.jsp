	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span">办案指南信息新建</span> &nbsp;
			...
			<form id="fm" action="${ctx}/handbook/insert.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<s:checkboxlist list="#{'1':'仲裁员','2':'助理','3':'当事人'}" name="handbook.ranges" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="handbook.putDate" type="text" size="25" class='Wdate {required:true}' onFocus="WdatePicker()" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="handbook.title" type="text" size="50" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="handbook.num" type="text" size="25" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
