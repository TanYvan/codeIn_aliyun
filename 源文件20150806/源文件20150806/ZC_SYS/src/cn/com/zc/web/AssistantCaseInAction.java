...
public class AssistantCaseInAction extends BaseAction {
	...
	public String getPartyinfo_1() throws UnsupportedEncodingException {
		return  java.net.URLDecoder.decode(partyinfo_1 , "UTF-8");
	}

	public void setPartyinfo_1(String partyinfo_1) throws UnsupportedEncodingException {
	...
	public String getReturnUrl() {
		if (returnUrl==null || returnUrl.equals("")){
			this.returnUrl="/assistantCaseIn/showAssistantCaseIn.do";
		}
		return returnUrl;
	}
	...
	public String findAssistantCaseInList() throws Exception {
		if (session.get("userType").toString().equals("assistant")){
			ArrayList<Param> params = new ArrayList<Param>();
			
			ReqPacket req= new ReqPacket();
			req.setFrom("tb_cases,users");
			...
			if (case_status.equals("1")){
				sql = "tb_cases.clerk=? and tb_cases.clerk=users.code and tb_cases.used='Y' and tb_cases.state>=4 and tb_cases.caseendbook_id_first is null";
			}
			else{
				sql = "tb_cases.clerk=? and tb_cases.clerk=users.code and tb_cases.used='Y' and tb_cases.state>=4 and tb_cases.caseendbook_id_first is not null";
			}
			...
			if (case_code != null && !"".equals(case_code)) {
				...
				params.add(new Param("case_code",java.net.URLEncoder.encode(case_code,"utf-8")));
			}
			if (partyinfo_1 != null && !"".equals(partyinfo_1)) {
				conditions.add("%" + partyinfo_1 + "%");
				params.add(new Param("partyinfo_1",java.net.URLEncoder.encode(partyinfo_1,"UTF-8")));
			}
			if (agent_1 != null && !"".equals(agent_1)) {
			...
			if (rp.getStatus().equals("1")){
				...
				page_bar = page_bar(rp,request.getContextPath() + "/assistantCaseIn/findAssistantCaseInList.do","list_page_bar");
				return SUCCESS;
			}
			else{
				return "fail";
	...
	public String showAssistantCaseIn() throws Exception {
