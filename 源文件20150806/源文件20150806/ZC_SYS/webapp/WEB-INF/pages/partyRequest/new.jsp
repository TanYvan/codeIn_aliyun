...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/css.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="request.new.title"></s:text></title>
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="request.new.title"></s:text></span> &nbsp;
			...
			<form id="fm" action="${ctx}/partyRequest/insertPartyRequest.do"
				method="post">
