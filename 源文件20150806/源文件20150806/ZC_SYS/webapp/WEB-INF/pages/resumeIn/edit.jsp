...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/resumeIn/updateResumeIn.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="resumeIn.id" type="hidden" size="30"  value="${resumeIn.id}"/>
							<input name="resumeIn.startdate" type="text" size="30" class='{required:true} Wdate' onFocus="WdatePicker()" value="${resumeIn.startdate}"/>
					...
					<tr>
						...
						<td>
							<input name="resumeIn.enddate" type="text" size="30" class='{required:true} Wdate' onFocus="WdatePicker()" value="${resumeIn.enddate}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeIn.company" type="text" size="50" class='{required:true}' value="${resumeIn.company}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeIn.business" type="text" size="50" class='{required:true}'  value="${resumeIn.business}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeIn.proveman" type="text" size=50 value="${resumeIn.proveman}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="resumeIn.remark" type="text" size="50" value="${resumeIn.remark}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
