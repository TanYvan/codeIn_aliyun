...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/languageIn/updateLanguageIn.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="languageIn.id" type="hidden" size="15" value="${languageIn.id}"/>
					...
					<tr>
						...
						<td>
							<input name="languageIn.remark" type="text" size="15" value="${languageIn.remark}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
