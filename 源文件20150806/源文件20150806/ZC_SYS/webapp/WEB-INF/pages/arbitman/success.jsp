		...
		<table width="98%" border="0" border="0" cellspacing="0"
			...
			<tr>
				<td align="center" bgcolor="#FFFFFF" class="font5">
					<s:text name="arbitman.register.code"></s:text>：${code}
					<a href="${ctx}/welcome/main.do?jump=${ctx}/arbitman/toUpdateArbitman.do?code=${code}"><s:text name="arbitman.registerDo.mes_3"></s:text></a>
				</td>
			</tr>
		</table>
	</body>
