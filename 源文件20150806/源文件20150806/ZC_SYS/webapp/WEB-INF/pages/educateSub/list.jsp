	...
	<body>
		<div align="center">
			...
			<table class="list_toolbar" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						<form action="${ctx}/educateSub/toInsertEducateSub.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				...
				<tbody>
					<%
						int i_tr = 0;
					%>
					<s:iterator value="educateSubList" status="user">
						<%
							i_tr++;
						%>
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<td>
								<form
									action="${ctx}/educateSub/toUpdateEducateSub.do?id=<s:property value='id'/>"
									method="post">
							...
							<td>
								<form
									action="${ctx}/educateSub/deleteEducateSub.do?id=<s:property value='id'/>"
