...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="arbitmanCaseAttIn.list.title"></s:text></title>
	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/arbitmanCaseIn/findArbitmanCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/arbitmanCaseAttIn/findArbitmanCaseAttInList.do" />
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="arbitmanCaseAttIn.list.title"></s:text></span>
					</td>
				</tr>
				<tr>
			...
			<table class="list_toolbar" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						<form action="${ctx}/arbitmanCaseAttIn/toInsertArbitmanCaseAttIn.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				<thead>
					<tr>
						<th>
							<s:text name="arbitmanCaseAttIn.list.head_description"></s:text>
						</th>
						<th>
							<s:text name="arbitmanCaseAttIn.list.head_category"></s:text>
						</th>
						<th>
							<s:text name="arbitmanCaseAttIn.list.head_up_time"></s:text>
						</th>
						<th>
							<s:text name="arbitmanCaseAttIn.list.head_file_name"></s:text>
						</th>
						<th>
							<s:text name="arbitmanCaseAttIn.list.head_remark"></s:text>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<s:iterator value="attachmentInList" status="att">
						...
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<td>
								<s:property value="baseDicMap['9103'][category]" />
								<s:property value="baseDicMap['9105'][category]" />
							</td>
							<td>
							...
							<td>
								...
								<a href="${ctx}/arbitmanCaseAttIn/downFile.do?id=<s:property value="id" />" target="_blank" class="edit_return"><s:text name="common.down"></s:text></a>
							</td>
							<td>
