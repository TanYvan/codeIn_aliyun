	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/partyCaseIn/findPartyCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/partyCaseAttIn/list.do" />
			...
			<table class="list_toolbar" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						<form action="${ctx}/partyCaseAttIn/toInsert.do" method="post">
					...
					<s:iterator value="attachmentInList" status="att">
						...
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<td>
								...
								<a href="${ctx}/partyCaseAttIn/downFile.do?id=<s:property value="id" />" target="_blank" class="edit_return"><s:text name="common.down"></s:text></a>
							</td>
							<td>
