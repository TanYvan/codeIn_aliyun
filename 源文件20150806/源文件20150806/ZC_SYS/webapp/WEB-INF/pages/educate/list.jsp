	...
	<body>
		<div align="center">
			...
			<table class="list_toolbar" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
						<form action="${ctx}/educate/toInsertEducate.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				...
				<tbody>
					<%
						int i_tr = 0;
					%>
					<s:iterator value="educateList" status="user">
						<%
							i_tr++;
						%>
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<td>
								<form
									action="${ctx}/educate/toUpdateEducate.do?id=<s:property value='id'/>"
									method="post">
							...
							<td>
								<form
									action="${ctx}/educate/deleteEducate.do?id=<s:property value='id'/>"
