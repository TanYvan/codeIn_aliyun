 ...
 * 
 * */
public class BpsSupportSingle {

	private static final BpsSupportSingle instance = new BpsSupportSingle();
...
//	private static final String CHARSET = "GBK";
	...
	private static String sinoBpsServiceUrl = ReadProperties.getString("defaultUrl");

	/** 日志功能 */
	private  Log log = LogFactory.getLog(this.getClass());

	/** 构造函数 */
	private BpsSupportSingle() {
	}

	/** 获取实例 */
	public static BpsSupportSingle getInstance() {
		return instance;
	}
...
//	}
	...
	public String execute(String fun, String xml) throws ExecutionException {
		// - HttpClientParams
		log.debug("server URL is :"+sinoBpsServiceUrl);
		...
		HttpClient httpClient = new HttpClient(httpClientParams,
				connectionManager);
		// - PostMethod
		PostMethod postMethod = new PostMethod(BpsSupportSingle.sinoBpsServiceUrl + fun);
