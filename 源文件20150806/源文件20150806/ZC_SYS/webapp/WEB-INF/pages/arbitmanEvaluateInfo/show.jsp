...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="arbitmanEvaluateInfo.show.title"></s:text></title>
	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/arbitmanCaseIn/findArbitmanCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/arbitmanEvaluateInfo/show.do" />
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="arbitmanEvaluateInfo.show.title"></s:text></span>
					</td>
				</tr>
				<tr>
			...
			<s:iterator value="arbitmanNameList" status="arb">
				<table class="list_data_table" cellpadding="0" cellspacing="1">
					<thead>
						<tr>
							<th>
								<s:text name="arbitmanEvaluateInfo.show.head_content"></s:text>
							</th>
							<th>
								<s:text name="arbitmanEvaluateInfo.show.head_score"></s:text>
							</th>
							<th>
								<s:text name="arbitmanEvaluateInfo.show.head_remark"></s:text>
							</th>
						</tr>
					</thead>
					<tbody>
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				...
				<tbody>
					...
					<s:iterator value="assistantEvaluateHash['assistant']" status="eval">
						<%
							i_tr++;
						%>
						...
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<s:if test="data_val.length()>4">
									<td>
										<s:property value="assistantEvaluateHash['assistant'].get(#eval.index).getScore()" />
									</td>
									<td>
										<s:property value="assistantEvaluateHash['assistant'].get(#eval.index).getRemark()" />
									</td>
							</s:if>
							<s:else>
								<td>	 
