...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="evaluatePartyToAssistant.list.title"></s:text>.</title>
	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/partyCaseIn/findPartyCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/evaluatePartyToAssistant/findEvaluatePartyToAssistantList.do" />
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="evaluatePartyToAssistant.list.title"></s:text>.</span>
					</td>
				</tr>
				<tr>
					...
					<table class="list_toolbar" cellspacing="0" cellpadding="0">
						<tr>
							...
							<s:if test="evaluateList.size()>0" >
								<form action="${ctx}/evaluatePartyToAssistant/toUpdateEvaluatePartyToAssistant.do" method="post">
									<input type="submit" name="SubmitNew" value="<s:text name="common.button_update"></s:text>" />
								</form>
							</s:if>
							<s:else> 
								<form action="${ctx}/evaluatePartyToAssistant/toInsertEvaluatePartyToAssistant.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				<thead>
					<tr>
						...
						<th colspan='2'>
							<s:text name="evaluatePartyToAssistant.list.head_assistant"></s:text>：<s:property value="clerk_name" />
						</th>
					</tr>
					<tr>
						<th>
							<s:text name="evaluatePartyToAssistant.list.head_content"></s:text>
						</th>
						<th>
							<s:text name="evaluatePartyToAssistant.list.head_score"></s:text>
						</th>
						<th>
							<s:text name="evaluatePartyToAssistant.list.head_remark"></s:text>
						</th>
					</tr>
				</thead>
				<tbody>
