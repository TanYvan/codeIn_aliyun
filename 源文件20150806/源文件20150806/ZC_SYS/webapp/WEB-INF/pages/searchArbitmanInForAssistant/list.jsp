...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div align="center">
			...
			<form action="${ctx}/searchArbitmanInForAssistant/findArbitmanInForAssistantList.do" method="post">
				...
				<tbody>
					...
					<s:iterator value="arbitmanInList" status="case">
						...
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							<td>
								<a href="${ctx}/showArbitmanIn/showArbitmanIn.do?arbitman_code=<s:property value="code" />" target="_blank" class="list_data"><s:property value="name_idcard" /></a>
							</td>
							<td>
								<a href="${ctx}/showArbitmanIn/showArbitmanIn.do?arbitman_code=<s:property value="code" />" target="_blank" class="list_data"><s:property value="name_idcard_en" /></a>
							</td>
							<td>
