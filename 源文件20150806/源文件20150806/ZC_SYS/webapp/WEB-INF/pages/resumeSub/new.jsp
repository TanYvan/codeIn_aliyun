...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/resumeSub/insertResumeSub.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="resumeSub.startdate" type="text" size="15" class='{required:true} Wdate' onFocus="WdatePicker()" />
					...
					<tr>
						...
						<td>
							<input name="resumeSub.enddate" type="text" size="15" class='{required:true} Wdate' onFocus="WdatePicker()" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeSub.company" type="text" size="15" class='{required:true}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeSub.business" type="text" size="15" class='{required:true}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resumeSub.proveman" type="text" size=50/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="resumeSub.remark" type="text" size="15" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
