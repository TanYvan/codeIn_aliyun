...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="welcome.toFindPsd_1.title"></s:text></title>
			...
			$.ajax( {
				...
				success : function(data) {
					if (data=="ok") {
						...
						alert('<s:text name="welcome.toFindPsd_1.mes_1"></s:text>');
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="15"></td>
                      <td width="40%" class="font2"><s:text name="welcome.toFindPsd_1.title"></s:text> &nbsp;<a href="#">（</a><a href="${ctx}/welcome/login_1.do" class="a5"><s:text name="welcome.toFindPsd_1.return"></s:text></a><a href="#">）</a></td>
                      <td width="15">&nbsp;</td>
      ...
      <tr>
        <td align="center" bgcolor="#FFFFFF">
	        <form id="fm" action="${ctx}/welcome/findPsd_1.do" method="post" target="_blank">
				<table width="560" border="0" cellspacing="0" cellpadding="0">
		          ...
		          <tr>
		            <td align="right" class="font" ><s:text name="welcome.toFindPsd_1.user_code"></s:text>：</td>
		          ...
		          <tr>
		            <td align="right" class="font"><s:text name="welcome.toFindPsd_1.veryCode"></s:text>：</td>
		            <td align="left">
		            	<input type="hidden" id="very" name="very" />
		            	<input type="text" id="veryCode" name="veryCode" />
		            	<img id="veryCode" title="<s:text name="welcome.toFindPsd_1.veryCode_title"></s:text>" onclick="javascript:refresh(this);" src="${ctx}/imageServlet">
		            </td>
		          </tr>
		          <tr>
		            <td align="right"></td>
		            <td align="left"><input name="SubmitOk" type="button" onclick="check();" class="btr_ok" value="<s:text name="welcome.toFindPsd_1.submit"></s:text>" /></td>
		          </tr>  
		        </table>
	        </form>
		</td>
