...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/wuser/updateMyInfo.do" method="post" enctype="multipart/form-data" >
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<input name="wuser.nameIdcard" type="text" size="25"  value="${wuser.nameIdcard}" class='{required:true,maxlength:20}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.idCard" type="text" size="25"  value="${wuser.idCard}" class='{required:true,minlength:18,maxlength:50}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.telephone" type="text" size="25"  value="${wuser.telephone}" class='{required:true,minlength:11,maxlength:15}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.email" type="text" size="25"  value="${wuser.email}" class='{required:true,maxlength:40,email:true}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="wuser.postCode" type="text" size="50"  value="${wuser.postCode}" class='{maxlength:6}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.company" type="text" size="50"  value="${wuser.company}" class='{maxlength:100}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.addr" type="text" size="50"  value="${wuser.addr}" class='{maxlength:100}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="wuser.fax" type="text" size="50"  value="${wuser.fax}" class='{maxlength:15}'/>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input name="wuser.otherContact" type="text" size="50"  value="${wuser.otherContact}" class='{maxlength:100}'/>
						</td>
					</tr>
					<tr>
						<th>
