...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/educateIn/insertEducateIn.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="educateIn.graduatedate" type="text" class='{required:true} Wdate' onFocus="WdatePicker()" size="30" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input name="educateIn.specialty" type="text" class='{required:true}' size="30" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input name="educateIn.school" type="text" class='{required:true}' size="30" />
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td>
							<input name="educateIn.degreeletter" type="text" size="30" />
						</td>
					</tr>
					<tr>
						<th>
