...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="evaluateArbitmanToAssistant.list.title"></s:text></title>
	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/arbitmanCaseIn/findArbitmanCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/evaluateArbitmanToAssistant/findEvaluateArbitmanToAssistantList.do" />
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="evaluateArbitmanToAssistant.list.title"></s:text></span>
					</td>
				</tr>
				<tr>
			...
			<table class="list_toolbar" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table class="list_toolbar" cellspacing="0" cellpadding="0">
						<tr>
							<td align="left" width='30px'>
							<s:if test="evaluateList.size()>0" >
								<form action="${ctx}/evaluateArbitmanToAssistant/toUpdateEvaluateArbitmanToAssistant.do" method="post">
									<input type="submit" name="SubmitNew" value="<s:text name="common.button_update"></s:text>" />
								</form>
							</s:if>
							<s:else> 
								<form action="${ctx}/evaluateArbitmanToAssistant/toInsertEvaluateArbitmanToAssistant.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				<thead>
					<tr>
						...
						<th colspan='2'>
							<s:text name="evaluateArbitmanToAssistant.list.head_assistant"></s:text>：<s:property value="clerk_name" />
						</th>
					</tr>
					<tr>
						<th>
							<s:text name="evaluateArbitmanToAssistant.list.head_content"></s:text>
						</th>
						<th>
							<s:text name="evaluateArbitmanToAssistant.list.head_score"></s:text>
						</th>
						<th>
							<s:text name="evaluateArbitmanToAssistant.list.head_remark"></s:text>
						</th>
					</tr>
				</thead>
				<tbody>
