...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="evaluateArbitmanToArbitman.list.title"></s:text></title>
	...
	<body>
		<div align="center">
				...
				<tr>
					...
					<td align="center">
						<form action="${ctx}/arbitmanCaseIn/findArbitmanCaseInList.do" method="post">
							<input type="hidden" name="returnUrl" value="/evaluateArbitmanToArbitman/findEvaluateArbitmanToArbitmanList.do" />
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="evaluateArbitmanToArbitman.list.title"></s:text></span>
					</td>
				</tr>
				<tr>
					...
					<table class="list_toolbar" cellspacing="0" cellpadding="0">
						<tr>
							...
							<s:if test="evaluateHash[arbit].size()>0" >
								<form action="${ctx}/evaluateArbitmanToArbitman/toUpdateEvaluateArbitmanToArbitman.do" method="post">
									<input type="submit" name="SubmitNew" value="<s:text name="common.button_update"></s:text>" />
								</form>
							</s:if>
							<s:else> 
								<form action="${ctx}/evaluateArbitmanToArbitman/toInsertEvaluateArbitmanToArbitman.do" method="post">
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				<thead>
					...
					<tr>
						<th>
							<s:text name="evaluateArbitmanToArbitman.list.head_content"></s:text>
						</th>
						<s:iterator value="caseArbitmanInList" >
						<th>
							<s:text name="evaluateArbitmanToArbitman.list.head_score"></s:text>
						</th>
						<th>
							<s:text name="evaluateArbitmanToArbitman.list.head_remark"></s:text>
						</th>
						</s:iterator>
					</tr>
				</thead>
