...
public class DownlogAction extends BaseAction {
	...
	public String findDownlogList() {
		...
		if (userType1 != null && !"".equals(userType1.trim())) {
			condition.append(" and user_type  = '" + userType1 + "'");
			page_str = page_str + "&userType1=" + userType1.trim();
		}
		...
		if (user != null && !"".equals(user.trim())) {
			condition.append(" and user_code like '%" + user.trim() + "%'");
			page_str = page_str + "&user=" + user.trim();
		}
		if (fileName != null && !"".equals(fileName.trim())) {
			condition.append(" and  file_name  like '%" + fileName.trim() + "%'");
