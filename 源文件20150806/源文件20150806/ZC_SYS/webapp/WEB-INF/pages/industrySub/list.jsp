		...
		<div align="center">
			...
			<div class="tabs" align="center">
		      <ul>
				...
				<li><a href="${ctx}/industrySub/findIndustrySubList.do" class="selected"><span><s:text name="arbitman.industry.title"></s:text></span></a></li>
				...
				<tr>
					<td align="left">
						<form action="${ctx}/dictionary/select_1.do" method="post">
							<input type="hidden" name="returnUrl" value="/industrySub/findIndustrySubList.do" />
							<input type="hidden" name="typCode" value="9100" />
							<input type="hidden" name="typName" value="<s:text name="arbitman.industry.title"></s:text>" />
							<input type="hidden" name="space" value="industrySub" />
							<input type="hidden" name="action" value="insertIndustrySub.do" />
			...
			<table class="list_data_table" cellpadding="0" cellspacing="1">
				...
				<tbody>
					<%
						int i_tr = 0;
					%>
					<s:iterator value="industrySubList" status="user">
						<%
							i_tr++;
						%>
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							...
							<td>
								<form
									action="${ctx}/industrySub/deleteIndustrySub.do?id=<s:property value='id'/>" method="post"  onsubmit="return confirm('<s:text name="common.button_delete_confirm"></s:text>');">
