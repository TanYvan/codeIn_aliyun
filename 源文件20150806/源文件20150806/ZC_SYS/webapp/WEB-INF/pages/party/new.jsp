...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/css.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="party.new.title"></s:text></title>
	...
	<body onload="pro1();pro_init();">
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="party.new.title"></s:text></span> &nbsp;
						<a href="${ctx}/caseApply/toUpdateCaseApply.do#sqrxx"
			...
			<form id="fm" action="${ctx}/party/insertParty.do" method="post">
