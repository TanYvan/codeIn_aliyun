...
public class EvaluatePartyToArbitmanAction  extends BaseAction{
	...
	public String findEvaluatePartyToArbitmanList() throws Exception{
			...
			if (rp.getStatus().equals("1")){
				...
				for(int i=0; i< caseArbitmanInList.size(); i++){
					...
					if (session.get("partyCategory")==null){
						...
						evaluateHash.put(caseArbitmanInList.get(i).getArbitman(), evaluateService.findEvaluateList(" and u=? and user_code=? and recevice_code=? and category='party_to_arbitman_1' and used='Y' order by id asc", value, 0, 0));
					}else if (session.get("partyCategory").toString().equals("2")){
						evaluateHash.put(caseArbitmanInList.get(i).getArbitman(), evaluateService.findEvaluateList(" and u=? and user_code=? and recevice_code=? and category='party_to_arbitman_2' and used='Y' order by id asc", value, 0, 0));
					}else{
	...
	public String toInsertEvaluatePartyToArbitman() throws Exception {
		if (recevice_code == null && session.get("receviceCode") == null){
			return "select_case";
		}
	...
	public String insertEvaluatePartyToArbitman() throws Exception {
		if (recevice_code == null && session.get("receviceCode") == null){
			return "select_case";
		}
				...
				while (caseArb.hasNext())
				  {
					...
					Iterator blInter = baseDicList.get("8163").iterator();
					while (blInter.hasNext())
					  {
						...
						if (session.get("partyCategory")==null){
							...
							eval.setCategory("party_to_arbitman_1");
						}else if (session.get("partyCategory").toString().equals("2")){
							eval.setCategory("party_to_arbitman_2");
						}else{
	...
	public String toUpdateEvaluatePartyToArbitman() throws Exception {
		if (recevice_code == null && session.get("receviceCode") == null){
			return "select_case";
		}
	...
	public String updateEvaluatePartyToArbitman() throws Exception {
		if (recevice_code == null && session.get("receviceCode") == null){
			return "select_case";
		}
		...
		if (session.get("userType").toString().equals("party") && session.get("receviceCode") != null){
			...
			if (session.get("partyCategory")==null){
				...
				evaList = evaluateService.findEvaluateList(" and u=? and recevice_code=? and category='party_to_arbitman_1' and used='Y' order by id asc", value, 0, 0);
			}else if (session.get("partyCategory").toString().equals("2")){
				evaList = evaluateService.findEvaluateList(" and u=? and recevice_code=? and category='party_to_arbitman_2' and used='Y' order by id asc", value, 0, 0);
			}else{
