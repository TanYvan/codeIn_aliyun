...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						...
						<a href="${ctx}/arbitmanAtt/findArbitmanAttList.do" class="edit_return"> <s:text name="common.return"></s:text></a>
					</td>
				</tr>
				<tr>
			...
			<form id="fm" action="${ctx}/arbitmanAtt/insertArbitmanAtt.do" method="post" enctype="multipart/form-data" onsubmit="return check();">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<s:select list="baseDicList['9101']" listKey="dataVal" listValue="dataText" name="attachment.category" />
					...
					<tr>
						...
						<td>
							<input name="attachment.remark" type="text" size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
