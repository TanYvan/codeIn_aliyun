	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span">培训信息新建</span> &nbsp;
			...
			<form id="fm" action="${ctx}/train/insert.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<s:checkboxlist list="#{'01':'在聘仲裁员','02':'候选仲裁员','03':'申请仲裁员候选人','11':'内网已经确认的当事人','12':'未确认的当事人'}" name="train.ranges" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="train.putDate" type="text" size="25" class='Wdate {required:true}' onFocus="WdatePicker()" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="train.title" type="text" size="25" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="train.doDate" type="text" size="25" class='Wdate {required:true}' onFocus="WdatePicker()" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="train.num" type="text" size="25" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
