...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/resume/insertResume.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="resume.startdate" type="text" size="30" class='{required:true} Wdate' onFocus="WdatePicker()" />
					...
					<tr>
						...
						<td>
							<input name="resume.enddate" type="text" size="30" class='{required:true} Wdate' onFocus="WdatePicker()" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.company" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.business" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.proveman" type="text" size=50/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="resume.remark" type="text" size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
