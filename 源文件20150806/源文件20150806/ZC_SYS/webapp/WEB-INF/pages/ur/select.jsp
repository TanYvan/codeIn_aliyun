...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="${ctx}/public/javascripts/jQuery.js">
	
</script>
	</head>
	<script language="javascript">
	function addMethod(roleCode) {
		var code = document.getElementById("code").value;
		$.ajax( {
			url : "${ctx}/ur/insertUr.do",
			type : 'POST',

			data : "roleCode=" + roleCode + "&code=" + code,
	...
	<body>
		<div align="center">
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span">角色信息选择列表</span>[for
						<s:property value='user' />
						] &nbsp;
						<a href="${ctx}/ur/toUpdateUr.do?user=<s:property value='user'/>"
				...
				<tbody>
					...
					<s:iterator value="roleList" status="role">
						...
						<tr class='<%=(i_tr%2==0)?"tr_even":"tr_odd"%>'>
							...
							<td>
								<form
									action="${ctx}/ur/insertUr.do?user=<s:property value='user'/>&roleCode=<s:property value='code'/>"
									method="post">
