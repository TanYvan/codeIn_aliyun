...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><s:text name="searchArbitmanInForUser.list.title"></s:text></title>
	...
	<body>
		<div align="center">
			...
			<table class="list_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="list_title_span"><s:text name="searchArbitmanInForUser.list.title"></s:text></span>
					</td>
				</tr>
				<tr>
			...
			<form action="${ctx}/searchArbitmanInForUser/findArbitmanInForUserList.do" method="post">
				...
				<tbody>
					...
					<s:iterator value="arbitmanInList" status="case">
						...
						<tr class='<%=(i_tr % 2 == 0) ? "tr_even" : "tr_odd"%>'>
							<td>
								<a href="${ctx}/searchArbitmanInForUser/showArbitman.do?arbitman_code=<s:property value="code" />" target="_blank" class="list_data"><s:property value="name_idcard" /></a>
							</td>
							<td>
