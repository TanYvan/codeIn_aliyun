...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/css.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="agent.new.title"></s:text></title>
		...
		<script language="javascript">
			function pro1(){
			  	var s1="<select name='agnet.profession' id='agnet_profession' onchange=\"pro2(this.value);\">";
			  	s1 = s1 + "${pro1}";
			  	s1 = s1 + "</select>";
			    $("#pro1").html(s1);
			}
			function pro2(code){
				var p="";
			  	${pro2}
			  	var s1="<select name='agnet.subprofession' id='agent_subprofession'>";
			  	s1 = s1 + p;
			  	s1 = s1 + "</select>";
			    $("#pro2").html(s1);
			}
			function pro_init(){
				pro2($("#agnet_profession").val());
			}
	...
	<body onload="pro1();pro_init();">
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="agent.new.title"></s:text></span> &nbsp;
			...
			<form id="fm" action="${ctx}/agent/insertAgent.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<input name="agent.postcode" type="text" size="10"
								value="${agent.postcode}" class='{maxlength:6}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="agent.company" type="text" size="25" class='{required:true}' 
								value="${agent.company}" class='{maxlength:100}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input name="agent.addr" type="text" size="40"
								value="${agent.addr}" class='{maxlength:100}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="agent.email" type="text" size="25"
								value="${agent.email}" class='{required:true,maxlength:40,email:true}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="agent.mobiletel" type="text" size="25"
								value="${agent.mobiletel}" class='{required:true,minlength:11,maxlength:15}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="agent.tel" type="text" size="25"
								value="${agent.tel}" class='{maxlength:40}'/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
