...
public class SelectArbitmanInForUserAction extends BaseAction {
	...
	public String findArbitmanInForUserList() throws Exception {
		...
		if (rp.getStatus().equals("1")){
			...
			page_bar = page_bar(rp,request.getContextPath() + "/selectArbitmanInForUser/findArbitmanInForUserList.do","list_page_bar");
			return SUCCESS;
		}
		else{
			return "fail";
	...
	public String select() throws Exception {
		...
		if (rp.getStatus().equals("1")){
			arbitmanInList = new ArbitmanIn().getObjects(rp);
			page_bar = page_bar(rp,request.getContextPath() + "/selectArbitmanInForUser/select.do","list_page_bar");
			return SUCCESS;
		}
		else{
			return "fail";
