...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title><s:text name="evaluatePartyToAssistant.edit.title"></s:text></title>
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="evaluatePartyToAssistant.edit.title"></s:text>.</span> &nbsp;
						<a href="${ctx}/evaluatePartyToAssistant/findEvaluatePartyToAssistantList.do" class="edit_return"> <s:text name="common.return"></s:text></a>
					</td>
				</tr>
				<tr>
			...
			<form id="fm" action="${ctx}/evaluatePartyToAssistant/updateEvaluatePartyToAssistant.do" method="post" enctype="multipart/form-data" onsubmit="return check();">
				<table class="list_data_table" cellpadding="0" cellspacing="1">
					<thead>
						<tr>
							...
							<th colspan="2">
								<s:text name="evaluatePartyToAssistant.edit.head_assistant"></s:text>：<s:property value="clerk_code" />
							</th>
						</tr>
						<tr>
							<th>
								<s:text name="evaluatePartyToAssistant.edit.head_content"></s:text>
							</th>
							<th>
								<s:text name="evaluatePartyToAssistant.edit.head_score"></s:text>
							</th>
							<th>
								<s:text name="evaluatePartyToAssistant.edit.head_remark"></s:text>
							</th>
						</tr>
					</thead>
					<tbody>
