...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/css.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="contractsign.edit.title"></s:text></title>
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="contractsign.edit.title"></s:text></span> &nbsp;
			...
			<form id="fm" action="${ctx}/contractsign/updateContractsign.do" method="post" >
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
						<textarea id="note" name="contractsign.note" rows="5" cols="60" class='{required:true,maxlength:200}'>${contractsign.note}</textarea>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
