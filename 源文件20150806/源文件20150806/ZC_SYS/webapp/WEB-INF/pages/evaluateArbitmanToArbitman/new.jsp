...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title><s:text name="evaluateArbitmanToArbitman.new.title"></s:text></title>
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="evaluateArbitmanToArbitman.new.title"></s:text></span> &nbsp;
			...
			<form id="fm" action="${ctx}/evaluateArbitmanToArbitman/insertEvaluateArbitmanToArbitman.do" method="post" enctype="multipart/form-data" onsubmit="return check();">
				<table class="list_data_table" cellpadding="0" cellspacing="1">
					<thead>
						...
						<tr>
							<th>
								<s:text name="evaluateArbitmanToArbitman.new.head_content"></s:text>
							</th>
							<s:iterator value="caseArbitmanInList" status="data">
								<th>
									<s:text name="evaluateArbitmanToArbitman.new.head_score"></s:text>
								</th>
								<th>
									<s:text name="evaluateArbitmanToArbitman.new.head_remark"></s:text>
								</th>
							</s:iterator>
						</tr>
					</thead>
					<tbody>
						<%
							int i_tr = 0;
						%>
						<s:iterator value="baseDicList['8161']" >
							<%
								i_tr++;
							%>
