		...
		<div align="center">
			...
			<div class="tabs" align="center">
		      <ul>
				...
				<li><a href="${ctx}/resume/findResumeList.do" class="selected"><span><s:text name="arbitman.resume.title"></s:text></span></a></li>
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						...
						<a href="${ctx}/resume/findResumeList.do" class="edit_return"> <s:text name="common.return"></s:text></a>
					</td>
				</tr>
				<tr>
			...
			<form id="fm" action="${ctx}/resume/updateResume.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="resume.id" type="hidden" size="15"  value="${resume.id}"/>
							<input name="resume.startdate" type="text" size="15" class='{required:true} Wdate' onFocus="WdatePicker()" value="${resume.startdate}"/>
					...
					<tr>
						...
						<td>
							<input name="resume.enddate" type="text" size="15" class='{required:true} Wdate' onFocus="WdatePicker()" value="${resume.enddate}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.company" type="text" size="50" class='{required:true}'  value="${resume.company}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.business" type="text" size="50" class='{required:true}' value="${resume.business}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.proveman" type="text" size=50 value="${resume.proveman}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<s:select name="resume.lawyerAbout" list="baseDicList['9902']" listKey="dataVal" listValue="dataText" ></s:select>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="resume.remark" type="text" size="50" value="${resume.remark}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
