...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/css.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="party2.new.title"></s:text></title>
	...
	<body onload="pro1();pro_init();">
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="party2.new.title"></s:text></span> &nbsp;
			...
			<form id="fm" action="${ctx}/party2/insertParty.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						<th>
							<span style="color: red">*</span> <s:text name="party2.new.partyName"></s:text>:
						</th>
						<td>
							<input name="party.partyName" type="text" size="25" class='{required:true,maxlength:100}' value="${party.partyName}" />
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.isPerson"></s:text>:
						</th>
						<td>
					...
					<tr>
						<th>
							<s:text name="party2.new.commissary"></s:text>：
						</th>
						<td>
							<input name="party.commissary" type="text" size="25" class='{maxlength:30}' value="${party.commissary}" />
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.dutyName"></s:text>:
						</th>
						<td>
							<s:select name="party.dutyName" list="baseDicList['8141']"
								listKey="dataVal" listValue="dataText"></s:select>
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.postTelCode"></s:text>：
						</th>
						<td>
							<input name="party.postTelCode" type="text" size="25"
								value="${party.postTelCode}" class='{maxlength:40}'/>
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.postcode"></s:text>：
						</th>
						<td>
					...
					<tr>
						<th>
							<s:text name="party2.new.profession"></s:text>：
						</th>
						<td>
							<div id="pro1">
					...
					<tr>
						<th>
							<s:text name="party2.new.subprofession"></s:text>：
						</th>
						<td>
							<div id="pro2">
								<select id="party.subprofession" name="party_subprofession">
								</select>
							</div>
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.addr"></s:text>：
						</th>
						<td>
							<input name="party.addr" type="text" size="25"
								value="${party.addr}" class='{maxlength:100}'/>
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.area"></s:text>：
						</th>
						<td>
							<s:select name="party.area" list="regionList"
								listKey="code" listValue="name"></s:select>
							<input type="button" value="<s:text name="common.button_select"></s:text>" onclick="aa()"/>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						<th>
							<s:text name="party2.new.mobileTel"></s:text>：
						</th>
						<td>
							<input name="party.mobileTel" type="text" size="25"
								value="${party.mobileTel}" class='{maxlength:40}'/>
						</td>
					</tr>
					<tr>
						<th>
							<s:text name="party2.new.tel"></s:text>：
						</th>
						<td>
