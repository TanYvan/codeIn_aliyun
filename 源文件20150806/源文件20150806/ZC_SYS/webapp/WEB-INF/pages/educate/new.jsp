...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/educate/insertEducate.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="educate.graduatedate" type="text" class='{required:true} Wdate' onFocus="WdatePicker()" size="30" />
					...
					<tr>
						...
						<td>
							<input name="educate.specialty" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="educate.school" type="text" class='{required:true}' size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input name="educate.degreeletter" type="text" size="30" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
