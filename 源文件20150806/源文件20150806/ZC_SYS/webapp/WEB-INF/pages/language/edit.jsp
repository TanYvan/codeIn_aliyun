...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div align="center">
			...
			<form id="fm" action="${ctx}/language/updateLanguage.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<input name="language.id" type="hidden" size="15" value="${language.id}"/>
					...
					<tr>
						...
						<td>
							<input name="language.remark" type="text" size="30" value="${language.remark}"/>
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
