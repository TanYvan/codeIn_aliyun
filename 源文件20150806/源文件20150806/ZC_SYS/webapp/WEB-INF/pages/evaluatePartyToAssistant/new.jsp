...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link href="${ctx}/public/stylesheets/tab.css" rel="stylesheet"
			type="text/css" />
		<title><s:text name="evaluatePartyToAssistant.new.title"></s:text>.</title>
	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span"><s:text name="evaluatePartyToAssistant.new.title"></s:text>.</span> &nbsp;
						<a
							href="${ctx}/evaluatePartyToAssistant/findEvaluatePartyToAssistantList.do"
			...
			<form id="fm"
				action="${ctx}/evaluatePartyToAssistant/insertEvaluatePartyToAssistant.do"
				...
				<table class="list_data_table" cellpadding="0" cellspacing="1">
					<thead>
						<tr>
							...
							<th colspan='2'>
								<s:text name="evaluatePartyToAssistant.new.head_assistant"></s:text><s:property value="clerk_name" />
							</th>
						</tr>
						<tr>
							<th>
								<s:text name="evaluatePartyToAssistant.new.head_content"></s:text>
							</th>
							<th>
								<s:text name="evaluatePartyToAssistant.new.head_score"></s:text>
							</th>
							<th>
								<s:text name="evaluatePartyToAssistant.new.head_remark"></s:text>
							</th>
						</tr>
					</thead>
					<tbody>
						<%
							int i_tr = 0;
						%>
						<s:iterator value="baseDicList['8164']">
							<%
								i_tr++;
							%>
