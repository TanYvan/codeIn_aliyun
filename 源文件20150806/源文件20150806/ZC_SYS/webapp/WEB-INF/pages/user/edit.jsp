	...
	<body>
		<div align="center">
			...
			<table class="edit_title" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<span class="edit_title_span">用户信息修改</span>
						&nbsp;
			...
			<form id="fm" action="${ctx}/user/updateUser.do" method="post">
				<table class="edit_data_table" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							${user.code}
							<input type="hidden" id="code" name="user.code" value="${user.code}" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							0755-
							<input name="user.fax" value="${user.fax}" />
							<div style="color: red"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="user.mobiletel" value="${user.mobiletel}" />
						</td>
					</tr>
					<tr>
						<th>
